...
struct qt_meta_stringdata_CLASSSqliteENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSSqliteENDCLASS = QtMocHelpers::stringData(
    "Sqlite"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSSqliteENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Sqlite::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSSqliteENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSSqliteENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSqliteENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *Sqlite::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSSqliteENDCLASS.stringdata0))
